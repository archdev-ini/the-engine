...
import { ArrowUpRight, BookOpen, FileText, Beaker, Landmark } from 'lucide-react';
    ...
    <div className="container mx-auto px-4 md:px-6 py-16 md:py-24">
      <div className="text-center max-w-3xl mx-auto">
        ...
        <p className="mt-4 text-muted-foreground md:text-lg">
          Explore the core documents that define the.Engine protocol. All materials are open-source and subject to community review.
        </p>
      </div>
