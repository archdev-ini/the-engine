...
export default function ProtocolOverview() {
  return (
    <section id="protocol-overview" className="py-16 md:py-24 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {components.map((component, index) => (
            <Card key={component.title} className="bg-secondary/50 border-border/50 hover:border-primary/50 transition-colors duration-300 transform hover:-translate-y-1">
